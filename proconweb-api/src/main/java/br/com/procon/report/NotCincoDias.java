...
//			Font minFont = FontFactory.getFont(FontFactory.HELVETICA, 10);
			...
			Paragraph conteudo = new Paragraph(
					"Notificamos Vossa Senhoria, para que se manifeste, conforme a determinação do Despacho Administrativo (anexo), no prazo de 5 (cinco) dias a contar do recebimento desta.",
					intFont);
