...
public class OperacaoController {
	...
	@GetMapping("/novos/{autos}")
	public ResponseEntity<List<ProcessoDto>> porNovos(@PathVariable String autos) {
		return ResponseEntity.ok(this.operacaoService.getNovos(autos));
	}
