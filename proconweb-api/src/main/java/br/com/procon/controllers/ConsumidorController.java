...
public class ConsumidorController {
	...
	public ResponseEntity<Page<Consumidor>> listar(@PathVariable String parametro,
			@PathVariable int pagina, @PathVariable int quant) {
		return ResponseEntity.ok(this.consumidorService.listar(parametro, pagina, quant));
	}
